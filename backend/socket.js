  ...
  io.on('connection', function (socket) {
    ...
    socket.on('send_message', async function (get_data) {
      try {
        ...
        console.log(get_reciever_data.dataValues, '==================>get_reciever_data');
        // return;
        
        if (get_reciever_data.dataValues.isOnline == 1) {
          ...
          console.log(get_reciever_data.dataValues.socketId, '================>get_reciever_data.dataValues.socketId');
          // return;
